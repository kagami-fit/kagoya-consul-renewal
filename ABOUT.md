...
- 進行中プロジェクトのデモカードで、開発・相続連携・賃貸運営の現場を写真付きで紹介する
- 社会貢献ページ内セクションで、空き家・相続、介護・地域連携、次の担い手への取り組みを紹介する
- 不動産コンサル・買取・地上げ／開発・権利調整・エフクリ・介護／相続・賃貸経営・新規事業／セミナーの8領域を写真付きで紹介する
...
- 社会貢献セクションと全ページ共通ナビゲーション：反映済み
- 8事業領域の見出し・写真カード・領域別導線：反映済み
- 進行中プロジェクトのデモ表示・相談／協業／投資／採用導線：反映済み
- 相談事例ページ：削除済み
